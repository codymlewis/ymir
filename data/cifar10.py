...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Download, preprocess and save the CIFAR 10 dataset.')
    parser.add_argument('file', metavar='FILE', type=str, nargs='?', default='~/ymir_datasets/cifar10',
